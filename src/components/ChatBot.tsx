...
const ChatBot = () => {
  ...
  const getBotResponse = (userMessage: string): string => {
    ...
    return 'Thank you for your question! For detailed assistance, please contact our support team at bluepaycustomerservice1@gmail.com or join our Telegram channel @https://t.me/+xinELtZYTQFjNjJk.';
  };
